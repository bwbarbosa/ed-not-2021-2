class Deque: 
    """  
        ESTUTURA DE DADOS DEQUE  - Deque = Double-Ended Queue (fila de duas pontas)  
        - Deque é uma lista linear de acesso restrito, que permite apenas as operações  
            ...
            (remove_front/remove_back), acontecendo em qualquer uma das extremidades da 
            estrutura.  
    ...
    """
        Método para remoção do inicio do deque
    """
    ...
    """
        Método para consultar o inicio do deque (primeiro elemento), sem retirá-lo
    """
    def peek_front(self):
        if self.is_empty(): return None
    ...
    """
        Método pra consultar o final do deque (último elemento), sem retirá-lo
    """
    def peek_back(self):
        if self.is_empty(): return None
    ...
    """
        Método para verificar se a deque está vazia ou não
    ...
    """
        Método que exibe a deque como uma string (para fins de depuração)
    """
    def to_str(self):
        string = ""
