"""
    ...
    2) O ponteiro para o próximo nodo da sequencia (__next)
"""
class Node:

    def __init__(self, val):
        self.data = val # Armazena a informação do usuário
        self.next = Node # Ponteiro para o próximo nodo (None = nenhum)
...
class LinkedList:
    ...
    def insert(self, pos, val):
        ...
        # 4º caso: inserção em posição intermediária
            ...
            # Nodo que ficará DEPOIS da inserção
            after = before.next

            # O nesxt do nodo inserido passa a ser o after
            inserted.next = after
    ...
    """
        Método de atalho para inserção na úlitma posição
    """
