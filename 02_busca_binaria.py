...
def busca_binaria(lista, valor_busca):
    '''
        ...
        Retorna a posição onde valor_busca foi encontrado ou o valor convencional -1 se valor_busca nâo existir na lista
    '''
    ...
    while ini <= fim:
        ...
        if lista[meio] == valor_busca: # Encontrou!
            return meio # meio é  posição onde valor_busca está na lista
