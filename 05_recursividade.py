...
# n! = n * (n - 1)! para n > 1
# Recursividade ocorre quando a definição uma função inclui a própria
# função sendo definida

# Em programanção, a recursividade se traduz quando uma função efetua
